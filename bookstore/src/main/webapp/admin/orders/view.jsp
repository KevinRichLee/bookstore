	...
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				订单编号：</td>
			<td class="ta_01" bgColor="#ffffff">${id}</td>
				...
				<table cellspacing="0" cellpadding="1" rules="all"
					...
					<c:forEach items="${products}" var="p" varStatus="vs">
						<tr
							...
							<td align="center" width="18%">${p.id }</td>
							<td align="center" width="10%">${p.name }</td>
							<td align="center" width="10%">${p.price }</td>
							<td width="7%" align="center">${p.buynum }</td>
							<td width="7%" align="center">${p.category }</td>
							<td width="31%" align="center">${p.description}</td>
						</tr>
					</c:forEach>
