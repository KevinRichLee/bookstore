		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath}/order/createOrder.do?user_id=${login_user.id}" method="post">
												...
												<c:forEach items="${cart}" var="entry" varStatus="vs">
													<table width="100%" border="0" cellspacing="0">
														<tr>
															...
															<td width="10%">
																<input name="buynum" type="text" value="${entry.value}" style="width:20px" readonly="readonly"/>
															</td>
