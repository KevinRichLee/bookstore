...
<script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/client/js/form.js"></script>
	<script type="text/javascript">
		...
		function checkByEmail() {
			var email=$("#email").val();
			$.post("${pageContext.request.contextPath}/user/checkEmail.do",{"email":email},
					function (data) {
						if(data=="EXIST"){
							alert("邮箱已存在,请重新输入")
							//阻止表单提交
		...
		function checkByName() {
			...
			$.post("${pageContext.request.contextPath}/user/checkUsername.do",{"username":username},
					function (data) {
						if(data=="EXIST"){
							alert("用户名已存在,请重新输入")
							//阻止表单提交
...
<body class="main">
<script src="${pageContext.request.contextPath}/admin/jquery/jquery-1.4.2.js"/>
<!-- 1.网上书城顶部 start -->
					...
					<td style="padding: 30px"><h1>新会员注册</h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width: 40%">
								<input type="text" class="textinput"  id="email" name="email" onblur="return checkByEmail()" onkeyup="checkEmail();"/>
								</td>
								<td colspan="2"><span id="emailMsg"></span><font color="#999999">请输入有效的邮箱地址</font></td>
							</tr>
							<tr>
								<td style="text-align: right">会员名：</td>
								<td><input type="text" class="textinput"  id="username" name="username" onblur="checkByName()" onkeyup="checkUsername();"/>
								</td>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width: 50%">
								<input type="text" class="textinput" name="verifiCode"/>&nbsp;&nbsp;&nbsp;<font color="red">${codeError}</font>
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
