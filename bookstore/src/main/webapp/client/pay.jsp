...
<body>
	<!-- <p:user/> -->
	<form action="${pageContext.request.contextPath}/order/onlinepay.do"
		method="post">
		订单号：<input type="text" name="id" value="${order.id}">
		支付金额：<input type="text" name="money" value="${order.money}">元
		<%--<div class="divBank">--%>
