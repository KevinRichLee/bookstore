					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>${category!=""?category:"全部商品"}</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${totalCount}种商品
								<hr />
										...
										<c:forEach items="${products}" var="p" varStatus="vs">
											<td>
												<div class="divbookpic">
													<p>
														<a href="${pageContext.request.contextPath}/client/findProductById.do?id=${p.id}">
															<img src="${pageContext.request.contextPath}${p.imgurl}" width="115" height="129" border="0" /> 
														</a>
													</p>
												</div>
												<div class="divlisttitle">
													<a href="${pageContext.request.contextPath}/client/findProductById.do?id=${p.id}">书名： ${p.name}<br />售价：￥${p.price} </a>
												</div>
											</td>
								...
								<div class="pagination">
									<ul>
										<yyf:pager pageIndex="${pageModel.pageIndex}"
												   ...
												   submitUrl="${pageContext.request.contextPath}/client/product_list.do?category=${category}&pageIndex={0}"></yyf:pager>
									</ul>
								</div>
							</td>
						</tr>
