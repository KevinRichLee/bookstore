...
<%@taglib prefix="p" uri="http://yyf.login-tag"%>
...
<script>
	function changeProductNum(count, totalCount, id) {
		...
		location.href = "${pageContext.request.contextPath}/client/changeCart.do?id="
				+ id + "&count=" + count;
	}
</script>
</head>
									...
									<tr>
										<td>
											...
											<c:forEach items="${cart}" var="entry" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%">
															<a href="${pageContext.request.contextPath}/client/changeCart.do?id=${entry.key.id}&count=0"
											...
											<div style="text-align:right; margin-top:10px">
												<a href="${pageContext.request.contextPath}/client/product_list.do">
