										...
										<tr>
											...
											<td class="tableopentd03">
												...
												<c:if test="${order.paystate==0 }">
													<a href="${pageContext.request.contextPath}/order/delOrderById.do?id=${order.id}">刪除</a>
												</c:if> 
												<c:if test="${order.paystate!=0 }">
													<a href="${pageContext.request.contextPath}/order/delOrderById.do?id=${order.id}&flag==1">刪除</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
