							...
							<c:forEach items="${orderList}" var="order">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/admin/queryOrderById.do?id=${order.id}&type=${loginAdminUser.role}">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><c:if
											...
											<a
												href="${pageContext.request.contextPath}/admin/delOrderById.do?id=${order.id}&type=${loginAdminUser.role}">
												<img
							...
							<div class="pagination" align="center">
								<ul>
									<yyf:pager pageIndex="${pageModel.pageIndex}"
											   ...
											   submitUrl="${pageContext.request.contextPath}/admin/order/list.do?pageIndex={0}"></yyf:pager>
								</ul>
							</div>
						</table>
					</td>
